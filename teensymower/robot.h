...
class Robot
{
  public:
    ...
    */
    ...
    unsigned long whereToStart; // use to know where the mower need to leave the wire and start to mow
    ...
    int areaToGo;// use to know the area where to start by timer
    ...
    const char* rfidToDoNameList(byte rfidToDoIndex);
