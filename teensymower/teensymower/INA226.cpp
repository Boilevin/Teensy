...
bool INA226::configure_I2C1(ina226_averages_t avg, ina226_busConvTime_t busConvTime, ina226_shuntConvTime_t shuntConvTime, ina226_mode_t mode)
{
    uint16_t config = 0;
    ...
    writeRegister16_I2C1(INA226_REG_CONFIG, config);
...
bool INA226::calibrate_I2C1(float rShuntValue, float iMaxExpected)
{
    uint16_t calibrationValue;
    rShunt = rShuntValue;
    ...
    writeRegister16_I2C1(INA226_REG_CALIBRATION, calibrationValue);
...
float INA226::readBusPower_I2C1(void)
{
...
float INA226::readBusVoltage_I2C1(void)
{
    int16_t voltage;

    voltage = readRegister16_I2C1(INA226_REG_BUSVOLTAGE);
